#!/usr/bin/env python3
"""Sync the objective server data required by the overnight skill."""
...
def main() -> None:
    ...
    result = sync_with_fallback(ServerDataClient(args.server, args.token), Path(args.cache_dir), "overnight")
